...
class MatchPredictor:
    """
    Utility class for predicting esports match outcomes using pre-trained models.
    """
    ...
    def print_map_prediction(self, prediction, teamA_name, teamB_name):
        ...
        print("\n" + "-"*60)
        print(f"MAP PREDICTION: {map_name}")
        print("-"*60)
    ...
    def print_series_prediction(self, series_prediction, teamA_name, teamB_name):
        ...
        """
        print("\n" + "="*60)
        print(f"SERIES PREDICTION: {teamA_name} vs {teamB_name} (Best of 3)")
        print("="*60)
    ...
    def print_detailed_prediction(self, prediction, teamA_name, teamB_name):
        ...
        print("\n" + "="*60)
        print(f"DETAILED MAP PREDICTION: {teamA_name} vs {teamB_name} on {map_name}")
        print("="*60)
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description='Predict esports match outcomes for a Bo3 series')
    ...
    predictor = MatchPredictor(args.model, args.data)
...
# Example usage:
# python match_predictor_symmetric.py --model output/esports_prediction_model.pkl --data match_data.xlsx --team1 "Complexity" --team2 "BIG" --team1-players "floppy,JT,Grim,Hallzerk,FaNg" --team2-players "tabseN,faveN,k1to,Krimbo,hyped"